...
import com.zk.framework.view.recycleadapter.callback.ItemDragAndSwipeCallback;
import com.zk.framework.view.recycleadapter.listener.OnItemDragListener;
import com.zk.framework.view.recycleadapter.listener.OnItemSwipeListener;
...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    protected OnItemDragListener<T> mOnItemDragListener;
    ...
    public BaseItemDraggableAdapter(int layoutResId, Context context) {
        super(layoutResId, context);
    }

    public BaseItemDraggableAdapter(List<T> data, Context context) {
        super(data, context);
    }

    public BaseItemDraggableAdapter(int layoutResId, List<T> data, Context context) {
        super(layoutResId, data, context);
    }
     ...
     */
    public void setOnItemDragListener(OnItemDragListener<T> onItemDragListener) {
    ...
    public void onItemDragEnd(RecyclerView.ViewHolder viewHolder) {
        if (mOnItemDragListener != null && itemDragEnabled) {
            mOnItemDragListener.onItemDragEnd(viewHolder, getViewHolderPosition(viewHolder), mData);
        }
    }
