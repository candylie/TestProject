    ...
    public void getItemOffsets(final Rect outRect, final View view, final RecyclerView parent, RecyclerView.State state) {
        ...
        if (mDrawable == null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mDrawable = mParent.getContext().getDrawable(mDividerId != 0 ? mDividerId : R.drawable.theme_blue_line_divider);
            } else {
                mDrawable = new ColorDrawable(Color.parseColor("#eaeaea"));
            }
        }
