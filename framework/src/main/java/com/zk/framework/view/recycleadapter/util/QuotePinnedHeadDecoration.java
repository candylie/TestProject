package com.zk.framework.view.recycleadapter.util;
...
import com.zk.framework.view.recycleadapter.callback.OnHeaderClickListener;
import com.zk.framework.view.recycleadapter.callback.OnItemTouchListener;

import java.lang.reflect.Field;
import java.util.ArrayList;

/**
 * 行情界面只带悬浮头不带分割线的Decoration
 *
 * @author zhangke
 * @date 2018/07/20
 * <p>这个是单独一个布局的标签</p>
 ...
 */
public class QuotePinnedHeadDecoration extends RecyclerView.ItemDecoration {
    ...
    private QuotePinnedHeadDecoration(Builder builder) {
    ...
    public static class Builder {
        ...
        public QuotePinnedHeadDecoration create() {
            return new QuotePinnedHeadDecoration(this);
        }
