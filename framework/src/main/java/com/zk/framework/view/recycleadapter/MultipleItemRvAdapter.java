...
import com.zk.framework.view.recycleadapter.provider.BaseItemProvider;
import com.zk.framework.view.recycleadapter.util.MultiTypeDelegate;
import com.zk.framework.view.recycleadapter.util.ProviderDelegate;
...
public abstract class MultipleItemRvAdapter<T, V extends BaseViewHolder> extends BaseQuickAdapter<T, V> {
    ...
    public MultipleItemRvAdapter(@Nullable List<T> data, Context context) {
        super(data, context);
    }
