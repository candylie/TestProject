...
import com.zk.framework.view.recycleadapter.BaseItemDraggableAdapter;
import com.zk.framework.view.recycleadapter.BaseQuickAdapter;
...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
    ...
    private ItemDragInterceptor itemDragInterceptor = ItemDragInterceptor.DEFAULT;

    public ItemDragAndSwipeCallback(BaseItemDraggableAdapter adapter) {
        mAdapter = adapter;
    }

    public ItemDragAndSwipeCallback(BaseItemDraggableAdapter adapter, ItemDragInterceptor itemDragInterceptor) {
        this.mAdapter = adapter;
        this.itemDragInterceptor = itemDragInterceptor;
    }
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState == ItemTouchHelper.ACTION_STATE_DRAG
                && !itemDragInterceptor.isDrag(viewHolder)) {
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (itemDragInterceptor.isDrag(viewHolder)) {
            return;
        }
    ...
    public void onMoved(RecyclerView recyclerView, RecyclerView.ViewHolder source, int fromPos, RecyclerView.ViewHolder target, int toPos, int x, int y) {
        ...
        if (!itemDragInterceptor.isDrag(target)) {
     ...
     * 拖动拦截器
     */
    public interface ItemDragInterceptor {
         ...
         * @return -
         */
        boolean isViewCreateByAdapter(RecyclerView.ViewHolder viewHolder);
         ...
         * @return -
         */
        boolean isDrag(RecyclerView.ViewHolder viewHolder);

        /**
         * 默认的实现类
         */
        public static ItemDragInterceptor DEFAULT = new ItemDragInterceptor() {
